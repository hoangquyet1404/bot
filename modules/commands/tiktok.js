...
module.exports.run = async ({ api, event, args }) => {
  ...
  const img = (await axios.get(`https://i.imgur.com/lnlmd6A.jpeg`, { responseType: "stream"})).data;
  if (!args[0]) return api.sendMessage({body:" ", attachment: img}, event.threadID, event.messageID);
