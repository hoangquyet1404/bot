...
module.exports.run = async function ({ api, args, event, Currencies, Users }) {
  const axios = require("axios");
    ...
    const datagame = (await axios.get(`http://101.32.128.19:8080/game/vuatiengviet`)).data;
    const random = datagame.keyword;
    const answer = datagame;
    let Avatar = (await axios.get(`http://101.32.128.19:8080/game/vuatiengviet/image?word=${encodeURI(random)}`, { responseType: "arraybuffer" } )).data; 
